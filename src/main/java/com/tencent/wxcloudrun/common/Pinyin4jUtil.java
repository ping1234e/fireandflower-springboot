...
public class Pinyin4jUtil {
     ...
     * @return String
     */
    public static String getNumber(String companyName, String projectName, String formName, String endStr) {
        if (companyName.length() > 2) {
            companyName = companyName.substring(0, 2);
        }
        if (projectName.length() > 4) {
            projectName = projectName.substring(0, 4);
        }
        companyName = Pinyin4jUtil.getFirstSpellPinYin(companyName, false);
        projectName = Pinyin4jUtil.getFirstSpellPinYin(projectName, false);
        return companyName + "-" + projectName + "-" + formName + "-" + endStr;
    }
     ...
     * @return String 值
     */
    public static String getEndStr(String endStr) {
        int num = Integer.parseInt(endStr) + 1;
        String numCode;
        if (num >= 0 && num < 10) {
            numCode = "00000" + num;
